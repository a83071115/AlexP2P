...
import alex.com.alexp2p.activity.GestureEditActivity;
import alex.com.alexp2p.activity.UserRegistActivity;
...
public class MoreFragment extends BaseFragment {
    ...
    private void showShare() {
        ...
        OnekeyShare oks = new cn.sharesdk.onekeyshare.OnekeyShare();
        //关闭sso授权
    ...
    private void contactService() {
        rlMoreContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(MoreFragment.this.getActivity())
                        .setTitle("联系客服")
                        .setMessage("是否现在联系客服：18246667728")
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                //获取手机号码
