...
import alex.com.alexp2p.ui.randomLayout.StellarMap;
...
public class ProductRecommondFragment extends BaseFragment {
    ...
    //提供装配的数据
    private String[] datas = new String[]{"君融贷-石油化工企业第三方担保融资项目", "财神道90天计划", "和盘贷-定期通B1702137", "30天理财计划(加息2%)", "180天理财计划(加息5%)", "月月升理财计划(加息10%)",
            "中情局投资商业经营", "大学老师购买车辆", "屌丝下海经商计划", "美人鱼影视拍摄投资", "去马尔代夫度假", "养猪场扩大经营",
